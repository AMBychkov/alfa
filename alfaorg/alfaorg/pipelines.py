...
class AlfaorgPipeline:
    ...
    def create_table(self):
        self.curr.execute("""DROP TABLE IF EXISTS alfa_org_tb""")
        self.curr.execute("""CREATE TABLE alfa_org_tb (
        lot_id text,
        etp text,
        lot_number text,
    ...
    def store_db(self, item):
        self.curr.execute("""
        INSERT INTO alfa_org_tb VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, 
